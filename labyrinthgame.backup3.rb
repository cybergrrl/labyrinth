...
def room_description
  if room == 1
    ...
    puts "This must be the barbie room: Shades ranging from soft baby pink to hot shrieking pink dominate here. It is beautifully gay and you feel like you might burst into song at any moment."
  elsif room == 5
  ...
  if room == 4
    ...
    if directions.include? x
	  ...
	  if x == "east"
	    if $col < 2   
	      $col += 1
		  #this is where i would now check what the room number is and give an output based on that number rather than have the string below. the content of what is displayed will have to be defined above. as a function that then gets called each time a player enters a direction and changes room?
          room_description
	    else 
